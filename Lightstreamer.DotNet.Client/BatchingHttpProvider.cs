...
namespace Lightstreamer.DotNet.Client
{
  internal class BatchingHttpProvider : HttpProvider
  {
    ...
    public virtual BatchingHttpProvider.BufferedReaderMonitor AddCall(
    ...
    public class BufferedReaderMonitor
    {
      ...
      public virtual LSStreamReader GetReader()
      {
        lock (this)
        {
          ...
          throw new SubscrException("Unexpected " + (object) ((object) this.error).GetType() + " :" + this.error.Message);
        }
      }
