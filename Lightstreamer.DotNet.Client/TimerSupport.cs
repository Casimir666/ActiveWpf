...
namespace Lightstreamer.DotNet.Client
{
  internal class TimerSupport
  {
    ...
    public void Schedule(IThreadRunnable task, long delay)
    {
      ...
      TimerSupport.TimerContext timerContext1 = new TimerSupport.TimerContext();
      timerContext1.task = task;
      int num = (int) delay;
      TimerSupport.TimerContext timerContext2 = timerContext1;
      int millisecondsDueTime = num;
      TimerSupport.TTimer ttimer = new TimerSupport.TTimer(callback, (object) timerContext2, millisecondsDueTime, -1);
      timerContext1.timer = ttimer;
      lock (this)
