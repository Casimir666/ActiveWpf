...
namespace Lightstreamer.DotNet.Client
{
  internal class CollectionsSupport
  {
    ...
    public static bool Add(ICollection c, object obj)
    {
      ...
      try
      {
        MethodInfo method = CollectionsSupport.GetMethod(c, nameof (Add));
        if ((object) method == null)
          method = CollectionsSupport.GetMethod(c, "add");
        if ((int) method.Invoke((object) c, new object[1]
        {
          obj
        }) >= 0)
          flag = true;
    ...
    public static void Clear(ICollection c)
    {
      try
      {
        MethodInfo method = CollectionsSupport.GetMethod(c, nameof (Clear));
        if ((object) method == null)
          method = CollectionsSupport.GetMethod(c, "clear");
        method.Invoke((object) c, new object[0]);
      }
      catch (Exception ex)
      {
        throw ex;
    ...
    public static bool Contains(ICollection c, object obj)
    {
      try
      {
        MethodInfo method = CollectionsSupport.GetMethod(c, nameof (Contains));
        if ((object) method == null)
          method = CollectionsSupport.GetMethod(c, "contains");
        return (bool) method.Invoke((object) c, new object[1]
        {
          obj
        });
      }
    ...
    {
      int num = 0;
      object[] instance = (object[]) Array.CreateInstance(objects.GetType().GetElementType(), new int[1]
      {
        c.Count
      });
      foreach (object obj in (IEnumerable) c)
