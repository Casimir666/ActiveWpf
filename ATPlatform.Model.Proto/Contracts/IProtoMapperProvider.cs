...
// Type: ATPlatform.Model.Proto.Contracts.IProtoMapperProvider
...
{
  public interface IProtoMapperProvider
  {
    IProtoMapper<TProto, TModel> GetMapper<TProto, TModel>() where TProto : IMessage, IMessage<TProto>;
  }
}
