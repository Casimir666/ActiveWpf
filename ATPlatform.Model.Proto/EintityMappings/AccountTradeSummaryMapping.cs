...
// Type: ATPlatform.Model.Proto.EntityMappings.AccountTradeSummaryMapping
...
{
  internal class AccountTradeSummaryMapping : 
    IProtoMapper<AccountTradeSummaryProto, AccountTradeSummary>
  {
    public AccountTradeSummary ModelFromProto(AccountTradeSummaryProto proto) => new AccountTradeSummary()
    {
    ...
    public AccountTradeSummaryProto ProtoFromModel(AccountTradeSummary model) => new AccountTradeSummaryProto()
    {
