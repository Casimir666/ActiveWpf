...
// Type: ATPlatform.IDL.EndOfDayOperationsRequestProto
...
{
  public sealed class EndOfDayOperationsRequestProto : 
    IMessage<EndOfDayOperationsRequestProto>,
    IMessage,
    IEquatable<EndOfDayOperationsRequestProto>,
    IDeepCloneable<EndOfDayOperationsRequestProto>
  {
    private static readonly MessageParser<EndOfDayOperationsRequestProto> _parser = new MessageParser<EndOfDayOperationsRequestProto>((Func<EndOfDayOperationsRequestProto>) (() => new EndOfDayOperationsRequestProto()));
    ...
    [DebuggerNonUserCode]
    public static MessageParser<EndOfDayOperationsRequestProto> Parser => EndOfDayOperationsRequestProto._parser;

    [DebuggerNonUserCode]
    public static MessageDescriptor Descriptor => ATPlatformMessagesReflection.Descriptor.MessageTypes[1];

    [DebuggerNonUserCode]
    MessageDescriptor IMessage.Descriptor => EndOfDayOperationsRequestProto.Descriptor;

    [DebuggerNonUserCode]
    public EndOfDayOperationsRequestProto()
    {
    }

    [DebuggerNonUserCode]
    public EndOfDayOperationsRequestProto(EndOfDayOperationsRequestProto other)
      : this()
    {
    ...
    [DebuggerNonUserCode]
    public EndOfDayOperationsRequestProto Clone() => new EndOfDayOperationsRequestProto(this);
    ...
    [DebuggerNonUserCode]
    public override bool Equals(object other) => this.Equals(other as EndOfDayOperationsRequestProto);

    [DebuggerNonUserCode]
    public bool Equals(EndOfDayOperationsRequestProto other)
    {
      if (other == null)
        return false;
      if (other == this)
    ...
    [DebuggerNonUserCode]
    public void MergeFrom(EndOfDayOperationsRequestProto other)
    {
      if (other == null)
        return;
