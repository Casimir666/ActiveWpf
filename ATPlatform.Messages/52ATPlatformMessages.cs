...
{
  public sealed class TickProto : 
    IMessage<TickProto>,
    IMessage,
    IEquatable<TickProto>,
    IDeepCloneable<TickProto>
  {
    private static readonly MessageParser<TickProto> _parser = new MessageParser<TickProto>((Func<TickProto>) (() => new TickProto()));
    ...
    [DebuggerNonUserCode]
    public static MessageParser<TickProto> Parser => TickProto._parser;

    [DebuggerNonUserCode]
    public static MessageDescriptor Descriptor => ATPlatformMessagesReflection.Descriptor.MessageTypes[34];

    [DebuggerNonUserCode]
    MessageDescriptor IMessage.Descriptor => TickProto.Descriptor;
    ...
    [DebuggerNonUserCode]
    public TickProto(TickProto other)
      : this()
    {
    ...
    [DebuggerNonUserCode]
    public TickProto Clone() => new TickProto(this);
    ...
    [DebuggerNonUserCode]
    public override bool Equals(object other) => this.Equals(other as TickProto);

    [DebuggerNonUserCode]
    public bool Equals(TickProto other)
    {
      if (other == null)
        return false;
      if (other == this)
        return true;
      return !(this.Symbol != other.Symbol) && this.Ask == other.Ask && (this.Bid == other.Bid && this.Timestamp == other.Timestamp) && this.Digits == other.Digits && object.Equals((object) this._unknownFields, (object) other._unknownFields);
    }
    ...
    [DebuggerNonUserCode]
    public void MergeFrom(TickProto other)
    {
      if (other == null)
        return;
