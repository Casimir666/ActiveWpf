...
// Type: ATPlatform.IDL.SymbolNotificationProto
...
{
  public sealed class SymbolNotificationProto : 
    IMessage<SymbolNotificationProto>,
    IMessage,
    IEquatable<SymbolNotificationProto>,
    IDeepCloneable<SymbolNotificationProto>
  {
    private static readonly MessageParser<SymbolNotificationProto> _parser = new MessageParser<SymbolNotificationProto>((Func<SymbolNotificationProto>) (() => new SymbolNotificationProto()));
    ...
    [DebuggerNonUserCode]
    public static MessageParser<SymbolNotificationProto> Parser => SymbolNotificationProto._parser;

    [DebuggerNonUserCode]
    public static MessageDescriptor Descriptor => ATPlatformMessagesReflection.Descriptor.MessageTypes[119];

    [DebuggerNonUserCode]
    MessageDescriptor IMessage.Descriptor => SymbolNotificationProto.Descriptor;

    [DebuggerNonUserCode]
    public SymbolNotificationProto()
    {
    }

    [DebuggerNonUserCode]
    public SymbolNotificationProto(SymbolNotificationProto other)
      : this()
    {
    ...
    [DebuggerNonUserCode]
    public SymbolNotificationProto Clone() => new SymbolNotificationProto(this);
    ...
    [DebuggerNonUserCode]
    public override bool Equals(object other) => this.Equals(other as SymbolNotificationProto);

    [DebuggerNonUserCode]
    public bool Equals(SymbolNotificationProto other)
    {
      if (other == null)
        return false;
      if (other == this)
    ...
    [DebuggerNonUserCode]
    public void MergeFrom(SymbolNotificationProto other)
    {
      if (other == null)
        return;
