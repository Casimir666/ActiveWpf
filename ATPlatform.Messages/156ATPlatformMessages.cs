...
// Type: ATPlatform.IDL.TicksRequestProto
...
{
  public sealed class TicksRequestProto : 
    IMessage<TicksRequestProto>,
    IMessage,
    IEquatable<TicksRequestProto>,
    IDeepCloneable<TicksRequestProto>
  {
    private static readonly MessageParser<TicksRequestProto> _parser = new MessageParser<TicksRequestProto>((Func<TicksRequestProto>) (() => new TicksRequestProto()));
    ...
    [DebuggerNonUserCode]
    public static MessageParser<TicksRequestProto> Parser => TicksRequestProto._parser;

    [DebuggerNonUserCode]
    public static MessageDescriptor Descriptor => ATPlatformMessagesReflection.Descriptor.MessageTypes[149];

    [DebuggerNonUserCode]
    MessageDescriptor IMessage.Descriptor => TicksRequestProto.Descriptor;

    [DebuggerNonUserCode]
    public TicksRequestProto()
    {
    }

    [DebuggerNonUserCode]
    public TicksRequestProto(TicksRequestProto other)
      : this()
    {
    ...
    [DebuggerNonUserCode]
    public TicksRequestProto Clone() => new TicksRequestProto(this);
    ...
    [DebuggerNonUserCode]
    public override bool Equals(object other) => this.Equals(other as TicksRequestProto);

    [DebuggerNonUserCode]
    public bool Equals(TicksRequestProto other)
    {
      if (other == null)
        return false;
      if (other == this)
    ...
    [DebuggerNonUserCode]
    public void MergeFrom(TicksRequestProto other)
    {
      if (other == null)
        return;
