...
// Type: ATPlatform.IDL.MarketDataEvents.MarketDataEventRequestProto
...
{
  public sealed class MarketDataEventRequestProto : 
    IMessage<MarketDataEventRequestProto>,
    IMessage,
    IEquatable<MarketDataEventRequestProto>,
    IDeepCloneable<MarketDataEventRequestProto>
  {
    private static readonly MessageParser<MarketDataEventRequestProto> _parser = new MessageParser<MarketDataEventRequestProto>((Func<MarketDataEventRequestProto>) (() => new MarketDataEventRequestProto()));
    ...
    [DebuggerNonUserCode]
    public static MessageParser<MarketDataEventRequestProto> Parser => MarketDataEventRequestProto._parser;

    [DebuggerNonUserCode]
    public static MessageDescriptor Descriptor => ATPlatformMarketDataEventsReflection.Descriptor.MessageTypes[5];

    [DebuggerNonUserCode]
    MessageDescriptor IMessage.Descriptor => MarketDataEventRequestProto.Descriptor;

    [DebuggerNonUserCode]
    public MarketDataEventRequestProto()
    {
    }

    [DebuggerNonUserCode]
    public MarketDataEventRequestProto(MarketDataEventRequestProto other)
      : this()
    {
    ...
    [DebuggerNonUserCode]
    public MarketDataEventRequestProto Clone() => new MarketDataEventRequestProto(this);
    ...
    [DebuggerNonUserCode]
    public override bool Equals(object other) => this.Equals(other as MarketDataEventRequestProto);

    [DebuggerNonUserCode]
    public bool Equals(MarketDataEventRequestProto other)
    {
      if (other == null)
        return false;
      if (other == this)
        return true;
      return object.Equals((object) this.MarketDataEvent, (object) other.MarketDataEvent) && this.Settings.Equals(other.Settings) && (this.Translations.Equals(other.Translations) && this.tags_.Equals(other.tags_)) && object.Equals((object) this._unknownFields, (object) other._unknownFields);
    }
    ...
    public override int GetHashCode()
    {
      ...
      int num2 = num1 ^ this.Settings.GetHashCode() ^ this.Translations.GetHashCode() ^ this.tags_.GetHashCode();
    ...
    public void WriteTo(CodedOutputStream output)
    {
      ...
      this.settings_.WriteTo(output, MarketDataEventRequestProto._map_settings_codec);
      this.translations_.WriteTo(output, MarketDataEventRequestProto._map_translations_codec);
      this.tags_.WriteTo(output, MarketDataEventRequestProto._repeated_tags_codec);
      if (this._unknownFields == null)
        return;
    ...
    public int CalculateSize()
    {
      ...
      int num2 = num1 + this.settings_.CalculateSize(MarketDataEventRequestProto._map_settings_codec) + this.translations_.CalculateSize(MarketDataEventRequestProto._map_translations_codec) + this.tags_.CalculateSize(MarketDataEventRequestProto._repeated_tags_codec);
      if (this._unknownFields != null)
    ...
    [DebuggerNonUserCode]
    public void MergeFrom(MarketDataEventRequestProto other)
    {
      if (other == null)
        return;
      ...
      while ((num = input.ReadTag()) != 0U)
      {
        switch (num)
        {
          case 10:
            ...
            continue;
          case 18:
            this.settings_.AddEntriesFrom(input, MarketDataEventRequestProto._map_settings_codec);
            continue;
          case 26:
            this.translations_.AddEntriesFrom(input, MarketDataEventRequestProto._map_translations_codec);
            continue;
          case 34:
            this.tags_.AddEntriesFrom(input, MarketDataEventRequestProto._repeated_tags_codec);
            continue;
          default:
