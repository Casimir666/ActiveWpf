...
// Type: ATPlatform.Common.Sessions.IDailySessionsService`1
...
{
  public interface IDailySessionsService<TSession> where TSession : IDailySession, new()
  {
    void Initialize(
    ...
    bool HasActiveSession(string sessionsOwner);

    void AddOrUpdate(string owner, IDailySessions<TSession> sessions);
  }
}
