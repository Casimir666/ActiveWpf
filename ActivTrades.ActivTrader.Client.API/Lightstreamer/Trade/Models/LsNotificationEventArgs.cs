...
// Type: ActivTrades.ActivTrader.Lightstreamer.Trade.Models.LsNotificationEventArgs
...
{
  public class LsNotificationEventArgs : EventArgs
  {
    public LsMessage Message { get; set; }
  }
}
