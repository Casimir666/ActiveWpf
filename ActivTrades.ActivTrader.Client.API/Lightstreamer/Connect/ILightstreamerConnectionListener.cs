...
// Type: ActivTrades.ActivTrader.Lightstreamer.Connect.ILightstreamerConnectionListener
...
{
  public interface ILightstreamerConnectionListener : IConnectionListener
  {
    event EventHandler<APIChannelStateChangedEventArgs> ConnectionStatusChanged;

    APIChannelState ChannelState { get; }
  }
}
