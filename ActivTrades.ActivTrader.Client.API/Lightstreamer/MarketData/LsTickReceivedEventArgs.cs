...
// Type: ActivTrades.ActivTrader.Lightstreamer.MarketData.LsTickReceivedEventArgs
...
{
  public class LsTickReceivedEventArgs : EventArgs
  {
    public TickProto Tick { get; set; }
  }
}
