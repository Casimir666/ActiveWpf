...
// Type: ActivTrades.ActivTrader.Lightstreamer.MarketData.LsMarketDataConnectionListener
...
{
  public class LsMarketDataConnectionListener : 
    LightstreamerConnectionListener,
    ILsMarketDataConnectionListener,
    ILightstreamerConnectionListener,
    IConnectionListener
  {
    public LsMarketDataConnectionListener(ILogger logger) => this._logger = logger;
  }
}
