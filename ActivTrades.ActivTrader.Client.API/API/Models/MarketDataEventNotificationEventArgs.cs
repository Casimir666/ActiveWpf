...
// Type: ActivTrades.ActivTrader.API.Models.MarketDataEventNotificationEventArgs
...
{
  public class MarketDataEventNotificationEventArgs : EventArgs
  {
    public MarketDataEvent MarketDataEvent { get; set; }
  }
}
