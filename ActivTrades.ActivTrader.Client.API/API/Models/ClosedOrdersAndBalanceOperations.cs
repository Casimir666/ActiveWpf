...
// Type: ActivTrades.ActivTrader.API.Models.ClosedOrdersAndBalanceOperations
...
{
  public class ClosedOrdersAndBalanceOperations
  {
    public ReadOnlyCollection<Order> ClosedOrders { get; set; }

    public ReadOnlyCollection<AccountBalanceOperation> AccountBalanceOperationsBalanceOperations { get; set; }
  }
}
