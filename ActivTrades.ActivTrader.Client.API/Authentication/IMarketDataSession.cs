...
// Type: ActivTrades.ActivTrader.Authentication.IMarketDataSession
...
{
  public interface IMarketDataSession : IAuthenticatedSession
  {
    string LsMarketDataHost { get; set; }

    string LsMarketDataAdapterSet { get; set; }

    string LsMarketDataAdapter { get; set; }
  }
}
