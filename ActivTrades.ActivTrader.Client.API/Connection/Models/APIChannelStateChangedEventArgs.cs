...
// Type: ActivTrades.ActivTrader.Connection.Models.APIChannelStateChangedEventArgs
...
{
  public class APIChannelStateChangedEventArgs : EventArgs
  {
    public APIChannelState OldState { get; set; }

    public APIChannelState NewState { get; set; }
