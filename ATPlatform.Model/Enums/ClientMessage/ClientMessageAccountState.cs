...
// Type: ATPlatform.Model.Enums.ClientMessage.ClientMessageAccountState
...
namespace ATPlatform.Model.Enums.ClientMessage
{
  public enum ClientMessageAccountState
  {
    Undefined,
    Read,
    Deleted,
